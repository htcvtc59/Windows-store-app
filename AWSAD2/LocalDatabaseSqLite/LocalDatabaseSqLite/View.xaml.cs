using LocalDatabaseSqLite.Common;
using SQLite;
using System;
...
namespace LocalDatabaseSqLite
{
    ...
    public sealed partial class View : Page
    {
        ...
        private async void btnFetchData_Click(object sender, RoutedEventArgs e)
        {
            ...
            var result = await conn.QueryAsync<Product>("select * from product");
        ...
        {
            var itemPro = (Product)e.ClickedItem;
            txtId.DataContext = itemPro;
            txtName.DataContext = itemPro;
            txtPrice.DataContext = itemPro;
        ...
        private async void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            await new MessageDialog("Delete Success").ShowAsync();
        ...
        private async void btnUpdate_Click(object sender, RoutedEventArgs e)
        {
            ...
            await new MessageDialog("Update Success").ShowAsync();
        }
    }
}
